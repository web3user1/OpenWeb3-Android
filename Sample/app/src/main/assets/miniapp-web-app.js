...
(function () {
  ...
  function postEvent(eventType, callback, eventData) {
    ...
    console.log('[OpenWeb3.WebView] > postEvent', eventType, eventData);
  ...
  function receiveEvent(eventType, eventData) {
    console.log('[OpenWeb3.WebView] < receiveEvent', eventType, eventData);
...
(function () {
  ...
  function onThemeChanged(eventType, eventData) {
    if (eventData.theme_params) {
      ...
      window.OpenWeb3.WebApp.SecondaryButton.setParams({});
      updateHeaderColor();
  ...
  function toggleVerticalSwipes(enable_swipes) {
    if (!versionAtLeast('7.7')) {
      console.warn('[OpenWeb3.WebApp] Changing swipes behavior is not supported in version ' + webAppVersion);
      return;
    }
  ...
  function toggleOrientationLock(locked) {
    if (!versionAtLeast('8.0')) {
      console.warn('[OpenWeb3.WebApp] Orientation locking is not supported in version ' + webAppVersion);
      return;
    }
  ...
  function setBottomBarColor(color) {
    if (!versionAtLeast('7.10')) {
      console.warn('[OpenWeb3.WebApp] Bottom bar color is not supported in version ' + webAppVersion);
      return;
    }
    var bg_color;
    if (color == 'bg_color' || color == 'secondary_bg_color' || color == 'bottom_bar_bg_color') {
      ...
      bg_color = parseColorToHex(color);
      if (!bg_color) {
        console.error('[OpenWeb3.WebApp] Bottom bar color format is invalid', color);
  ...
  var BottomButtonConstructor = function(type) {
    ...
    function setParams(params) {
      if (typeof params.text !== 'undefined') {
        ...
        if (!text.length) {
          console.error('[OpenWeb3.WebApp] Bottom button text is required', params.text);
          throw Error('WebAppBottomButtonParamInvalid');
        }
        if (text.length > 64) {
          console.error('[OpenWeb3.WebApp] Bottom button text is too long', text);
          throw Error('WebAppBottomButtonParamInvalid');
        }
        buttonText = text;
      }
      if (typeof params.color !== 'undefined') {
        if (params.color === false ||
          ...
          if (!color) {
            console.error('[OpenWeb3.WebApp] Bottom button color format is invalid', params.color);
            throw Error('WebAppBottomButtonParamInvalid');
          }
          buttonColor = color;
        }
      ...
      if (typeof params.text_color !== 'undefined') {
        if (params.text_color === false ||
          ...
          if (!text_color) {
            console.error('[OpenWeb3.WebApp] Bottom button text color format is invalid', params.text_color);
            throw Error('WebAppBottomButtonParamInvalid');
          }
      ...
      if (typeof params.is_visible !== 'undefined') {
        if (params.is_visible &&
          ...
          console.error('[OpenWeb3.WebApp] Bottom button text is required');
          throw Error('WebAppBottomButtonParamInvalid');
        }
        isVisible = !!params.is_visible;
      }
      ...
      if (!isMainButton && typeof params.position !== 'undefined') {
        if (params.position != 'left' && params.position != 'right' &&
          ...
          console.error('[OpenWeb3.WebApp] Bottom button posiition is invalid', params.position);
          throw Error('WebAppBottomButtonParamInvalid');
        }
  ...
  var LocationManager = (function() {
    ...
    function checkVersion() {
      if (!versionAtLeast('8.0')) {
        console.warn('[OpenWeb3.WebApp] LocationManager is not supported in version ' + webAppVersion);
        return false;
      }
      return true;
    }
    ...
    function checkInit() {
      if (!isInited) {
        console.error('[OpenWeb3.WebApp] LocationManager should be inited before using.');
    ...
    locationManager.getLocation = function(callback) {
      ...
      if (!isLocationAvailable) {
        console.error('[OpenWeb3.WebApp] Location is not available on this device.');
    ...
    locationManager.openSettings = function() {
      ...
      if (!isAccessRequested) {
        console.error('[OpenWeb3.WebApp] Location access was not requested yet.');
        throw Error('WebAppLocationManagerLocationAccessNotRequested');
      }
      if (isAccessGranted) {
        console.warn('[OpenWeb3.WebApp] Location access was granted by the user, no need to go to settings.');
        return locationManager;
      }
  ...
  var Accelerometer = (function() {
    ...
    function checkVersion() {
      if (!versionAtLeast('8.0')) {
        console.warn('[OpenWeb3.WebApp] Accelerometer is not supported in version ' + webAppVersion);
        return false;
      }
      return true;
    }
    ...
    accelerometer.start = function(params, callback) {
      ...
      if (isNaN(refresh_rate) || refresh_rate < 20 || refresh_rate > 1000) {
        console.warn('[OpenWeb3.WebApp] Accelerometer refresh_rate is invalid', refresh_rate);
      } else {
  ...
  var DeviceOrientation = (function() {
    ...
    function checkVersion() {
      if (!versionAtLeast('8.0')) {
        console.warn('[OpenWeb3.WebApp] DeviceOrientation is not supported in version ' + webAppVersion);
        return false;
      }
      return true;
    }
    ...
    deviceOrientation.start = function(params, callback) {
      ...
      var refresh_rate = parseInt(params.refresh_rate || 1000);
      if (isNaN(refresh_rate) || refresh_rate < 20 || refresh_rate > 1000) {
        console.warn('[OpenWeb3.WebApp] DeviceOrientation refresh_rate is invalid', refresh_rate);
      } else {
        req_params.refresh_rate = refresh_rate;
      }
  ...
  var Gyroscope = (function() {
    ...
    function checkVersion() {
      if (!versionAtLeast('8.0')) {
        console.warn('[OpenWeb3.WebApp] Gyroscope is not supported in version ' + webAppVersion);
        return false;
      }
      return true;
    }
    ...
    gyroscope.start = function(params, callback) {
      ...
      var refresh_rate = parseInt(params.refresh_rate || 1000);
      if (isNaN(refresh_rate) || refresh_rate < 20 || refresh_rate > 1000) {
        console.warn('[OpenWeb3.WebApp] Gyroscope refresh_rate is invalid', refresh_rate);
      } else {
        req_params.refresh_rate = refresh_rate;
      }
  ...
  WebApp.requestFullscreen = function() {
    if (!versionAtLeast('8.0')) {
      console.error('[OpenWeb3.WebApp] Method requestFullscreen is not supported in version ' + webAppVersion);
      throw Error('WebAppMethodUnsupported');
    }
  ...
  WebApp.exitFullscreen = function() {
    if (!versionAtLeast('8.0')) {
      console.error('[OpenWeb3.WebApp] Method exitFullscreen is not supported in version ' + webAppVersion);
      throw Error('WebAppMethodUnsupported');
    }
  ...
  WebApp.addToHomeScreen = function() {
    if (!versionAtLeast('8.0')) {
      console.error('[OpenWeb3.WebApp] Method addToHomeScreen is not supported in version ' + webAppVersion);
      throw Error('WebAppMethodUnsupported');
    }
  ...
  WebApp.checkHomeScreenStatus = function(callback) {
    if (!versionAtLeast('8.0')) {
      console.error('[OpenWeb3.WebApp] Method checkHomeScreenStatus is not supported in version ' + webAppVersion);
      throw Error('WebAppMethodUnsupported');
    }
    if (callback) {
  ...
  WebApp.switchInlineQuery = function (query, choose_chat_types) {
    ...
    if (!initParams.tgWebAppBotInline) {
      console.error('[OpenWeb3.WebApp] Inline mode is disabled for this bot. Read more about inline mode: https://core.telegram.org/bots/inline');
  ...
  WebApp.openOpenWeb3Link = function (url, options) {
    var a = document.createElement('A');
    a.href = url;
    if (a.protocol != 'http:' &&
        a.protocol != 'https:') {
  ...
  WebApp.downloadFile = function (params, callback) {
    if (!versionAtLeast('8.0')) {
      console.error('[OpenWeb3.WebApp] Method downloadFile is not supported in version ' + webAppVersion);
      throw Error('WebAppMethodUnsupported');
    }
    if (webAppDownloadFileRequested) {
      console.error('[OpenWeb3.WebApp] Popup is already opened');
    ...
    if (!params || !params.url || !params.url.length) {
      console.error('[OpenWeb3.WebApp] Url is required');
    ...
    if (!params || !params.file_name || !params.file_name.length) {
      console.error('[OpenWeb3.WebApp] File name is required');
      throw Error('WebAppDownloadFileParamInvalid');
    }
  ...
  WebApp.shareToStory = function (media_url, params) {
    ...
    if (!versionAtLeast('7.8')) {
      console.error('[OpenWeb3.WebApp] Method shareToStory is not supported in version ' + webAppVersion);
      throw Error('WebAppMethodUnsupported');
    }
    var a = document.createElement('A');
    a.href = media_url;
    if (a.protocol != 'http:' &&
        a.protocol != 'https:') {
      console.error('[OpenWeb3.WebApp] Media url protocol is not supported', url);
    ...
    if (typeof params.text !== 'undefined') {
      var text = strTrim(params.text);
      if (text.length > 2048) {
        console.error('[OpenWeb3.WebApp] Text is too long', text);
    ...
    if (typeof params.widget_link !== 'undefined') {
      ...
      if (a.protocol != 'http:' &&
          a.protocol != 'https:') {
        console.error('[OpenWeb3.WebApp] Link protocol is not supported', url);
        throw Error('WebAppShareToStoryParamInvalid');
      }
      var widget_link = {
        url: a.href
      ...
      if (typeof params.widget_link.name !== 'undefined') {
        ...
        if (link_name.length > 48) {
          console.error('[OpenWeb3.WebApp] Link name is too long', link_name);
          throw Error('WebAppShareToStoryParamInvalid');
        }
  ...
  WebApp.shareMessage = function (msg_id, callback) {
    if (!versionAtLeast('8.0')) {
      console.error('[OpenWeb3.WebApp] Method shareMessage is not supported in version ' + webAppVersion);
      throw Error('WebAppMethodUnsupported');
    }
    if (WebAppShareMessageOpened) {
      console.error('[OpenWeb3.WebApp] Share message is already opened');
  ...
  WebApp.setEmojiStatus = function (custom_emoji_id, params, callback) {
    params = params || {};
    if (!versionAtLeast('8.0')) {
      console.error('[OpenWeb3.WebApp] Method setEmojiStatus is not supported in version ' + webAppVersion);
      throw Error('WebAppMethodUnsupported');
    }
    var status_params = {};
    ...
    if (WebAppEmojiStatusRequested) {
      console.error('[OpenWeb3.WebApp] Emoji status is already requested');
  ...
  WebApp.requestEmojiStatusAccess = function (callback) {
    if (!versionAtLeast('8.0')) {
      console.error('[OpenWeb3.WebApp] Method requestEmojiStatusAccess is not supported in version ' + webAppVersion);
      throw Error('WebAppMethodUnsupported');
    }
    if (WebAppEmojiStatusAccessRequested) {
      console.error('[OpenWeb3.WebApp] Emoji status permission is already requested');
